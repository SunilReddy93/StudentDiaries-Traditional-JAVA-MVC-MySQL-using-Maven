...
<%
    ...
    else if (session.getAttribute("adminuser") != null && session.getAttribute("password") != null)
    {
                ...
                <form action="/signup" method="post" id="myform">
                    ...
                    <div class="form-row">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="school" placeholder="School/College" id="school" required>
                        ...
                        <div class="lastdiv col-md-6 final">
                            <p>Already an Admin Member? <a href="AdminLogin.jsp">Signin</a></p>
                        </div>
...
<script src="javascript/DBVerification/AdminEmailDBVerification.js"></script>
