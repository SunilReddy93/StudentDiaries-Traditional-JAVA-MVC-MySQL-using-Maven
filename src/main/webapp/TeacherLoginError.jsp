...
<head>
    ...
    <title>StudentDiaries | Login Error</title>
</head>
    ...
    <div class="container loginform">
        <div class="row">
            ...
            <div class="col-md-6" id="message">
                ...
                <h2>Oops! Something went wrong while Signing in. Please try again. </h2>

                <p>Click here for Teacher Login <a href="TeacherLogin.jsp">Login</a></p>
