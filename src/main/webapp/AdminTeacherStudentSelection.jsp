        ...
        <div class="row">
            <div class="col-md-4">
                <div class="fafaicons form-inline">
                    <a href="AdminDashboard.jsp"><i class="material-icons md-dark">arrow_back</i></a><h4 class="align-items-end">Teachers</h4>
                </div>
            </div>
            ...
            <div class="col">
                <table class="table table-hover" id="table1">
                    ...
                    <%
                        ...
                        /*Create AdminDao and Admin objects as required methods are already defined in adminDao class */
                        ...
                        teachers = adminDao.getTeacherInfo(admin);
                    ...
                    <tr>
                        <form action="AdminStudentUsers2.jsp" method="post">
                            ...
                            <td><%= WordUtils.capitalizeFully(teachers.get(i).getTeachercoursename()) %></td>
                            <td>
