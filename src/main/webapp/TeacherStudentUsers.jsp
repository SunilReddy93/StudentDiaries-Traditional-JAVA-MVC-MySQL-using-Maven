...
delete</i></span></a>
                    ...
                    <div class=" d-flex justify-content-end float-right">
                        <a href="TeacherStudentSignup.jsp" title="Add Student"><span><i class="material-icons md-dark">person_add</i></span></a>
                    </div>
...
<script src="javascript/AJAX/TeacherStudentDelete.js"></script>

<script src="javascript/AJAX/TeacherStudentView.js"></script>

<script src="javascript/AJAX/TeacherStudentFeedback.js"></script>
