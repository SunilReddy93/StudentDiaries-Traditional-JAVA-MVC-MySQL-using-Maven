...
<head>
    ...
    <link rel="stylesheet" href="mycss/users/teacherview.css"/>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="fafaicons form-inline">
                        <a href="AdminDashboard.jsp" id="arrowback"><i class="material-icons md-dark">arrow_back</i></a><h4 class="align-items-end">Teachers</h4>
                    </div>
                </div>
...
delete</i></span></a>
                    ...
                    <div class="fafaicons d-flex justify-content-end float-right">
                        <a href="AdminTeacherSignup.jsp" title="Add Teacher"><span><i class="material-icons md-dark">person_add</i></span></a>
                    </div>
                ...
                <div class="col">
                    <table class="table table-hover" id="table1">
                        ...
                        <tr>
                            ...
                            <td><%= WordUtils.capitalizeFully(teacherinfo.get(i).getTeachercoursename()) %></td>
...
<script src="javascript/AJAX/AdminTeacherDeletion.js"></script>
<!--<script src="javascript/AJAX/TeacherUpdate.js"></script>-->
<script src="javascript/AJAX/TeacherView.js"></script>
