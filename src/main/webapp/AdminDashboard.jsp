...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                <a href="AdminTeacherUsers.jsp" class="teacherspage list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Teachers</span>
                </a>
                <a href="AdminTeacherStudentSelection.jsp" class="studentspage list-group-item list-group-item-action bg-dark text-white">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="AdminProfileSettings.jsp" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Profile Settings</span>
                </a>
                <a href="AdminChangePassword.jsp" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <!-- /END Separator -->
            <a href="AdminCalendar.jsp" class="bg-white text-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <%
        int sessionadminid = Integer.parseInt(session.getAttribute("sessionadminid").toString());
        Admin admin = new Admin();
        admin.setAdminid(sessionadminid);

        AdminDao adminDao = new AdminDao();
        int count = adminDao.countTeachers(admin);//count is the number of teachers
        ...
        <div class="card text-center col-md-6 col-lg-12 countcard">
            ...
            <div class="card-body align-items-center">
                ...
                <div class="text-center">
                    ...
                    <small><span id="fullname2"><%= StringUtils.capitalize(session.getAttribute("sessionadminfirstname").toString()) %> <%= StringUtils.capitalize(session.getAttribute("sessionadminlastname").toString()) %></span></small>
                </div>
            </div>
...
<!--To load pages dynamically into div element-->
<!--<script src="javascript/Dashboard/AjaxDashboard.js"></script> -->


<!--LINE CHART-->
<script src="javascript/Dashboard/AdminDashboardChart.js"></script>

<!--TEACHER COUNT-->
<script src="javascript/Dashboard/AdminDashboardTeacherCount.js"></script>
