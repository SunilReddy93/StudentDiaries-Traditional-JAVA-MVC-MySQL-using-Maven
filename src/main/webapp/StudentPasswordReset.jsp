...
<div class="col-md-6 offset-md-3">
    ...
    <div class="card card-outline-secondary">
        ...
        <div class="card-body">
            <form class="form" role="form" autocomplete="off" action="/StudentPasswordResetSubmit" method="post">
                ...
                <div class="form-group">
                    <a class="btn btn-primary btn-lg" href="StudentLogin.jsp">Go back</a>
...
<section id="footer" class="col-lg-12 col-md-6 col-sm-6 bg-light align-items-center">
