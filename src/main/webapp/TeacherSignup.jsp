...
<section>
    <div class="container signupform">
        <div class="row">
            ...
            <div class="col">
                <form action="/signup" method="POST" id="myform2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 final">
                            <p>Already a Student Member? <a href="TeacherLogin.jsp">Signin</a></p>
                        </div>
...
<!--DB VERIFICATION-->
<script src="javascript/DBVerification/TeacherEmailDBVerification.js"></script>
<script src="javascript/DBVerification/TeacherPhoneDBVerification.js"></script>

<script src="javascript/AJAX/AjaxTeacherAdminId.js"></script>
<script src="javascript/AJAX/AjaxTeacherAdminSchoolSignup.js"></script>
