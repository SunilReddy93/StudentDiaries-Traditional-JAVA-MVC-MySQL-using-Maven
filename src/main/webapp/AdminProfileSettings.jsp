...
<header id="header">
    <div class="container container1" id="container-header" >
        <div class="row">
            <div class="col-md-6">
                <div class="fafaicons">
                    <a href="AdminDashboard.jsp" title="Dashboard"><i class="material-icons md-dark">arrow_back</i></a>
                </div>
            </div>


            <div class="fafaicons d-flex justify-content-end float-right ml-auto">
                <a  href="AdminEditProfile.jsp" title="Edit Profile"><span><i class="material-icons">
create</i></span></a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/AdminAccountDeletion"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section>
    <div class="container py-3">
        <div class="card">
            <div class="row ">
                <div class="col-md-4">
                    <img id="image" src="images/giphy.gif" class="img-fluid w-100 img-responsive d-flex justify-content-center align-items-center">
                </div>
                <div class="col-md-8 px-3">
                    <div class="card-block px-3">
                        ...
                        <p class="card-text">Admin ID: <%= admin.getAdminid() %>, <%= WordUtils.capitalizeFully(admin.getAdminschoolname()) %>, <%= StringUtils.capitalize(admin.getAdmincity()) %> </p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><p><span><i class="fa fa-envelope"></i></span>  <%= admin.getAdminemailid() %></p></li>
                            <li class="list-group-item"><p><span><i class="fa fa-phone"></i></span>  <%= admin.getAdminphoneno() %></p> </li>
