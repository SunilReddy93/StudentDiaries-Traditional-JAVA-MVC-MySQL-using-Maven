...
<div class="col-md-6 offset-md-3">
    ...
    <div class="card card-outline-secondary">
        ...
        <div class="card-body">
            <form class="form" role="form" autocomplete="off" action="/TeacherPasswordResetSubmit" method="post">
                ...
                <div class="form-group">
                    <a class="btn btn-primary btn-lg" href="TeacherLogin.jsp">Go back</a>
