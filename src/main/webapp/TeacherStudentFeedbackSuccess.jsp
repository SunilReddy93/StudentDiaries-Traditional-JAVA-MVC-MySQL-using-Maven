...
<head>
    ...
    <link rel="stylesheet" href="mycss/users/successorfailure.css"/>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <title>StudentDiaries | Feedback Status</title>
</head>
...
<section>
    <div class="container loginform">
        <div class="row">
            <div class="col-md-6">
                <img class = "img-fluid w-50 h-100 img-responsive" src="images/success.jpg">
                <!--    <p class="caption">Explore infinite possibilities.</p> -->
            </div>
            <div class="col-md-6" id="message">

                <h4>Successfully inserted the feedback. </h4>

                <p>Want to go back to Dashboard? <a href="TeacherDashboard.jsp">Click Here</a></p>
