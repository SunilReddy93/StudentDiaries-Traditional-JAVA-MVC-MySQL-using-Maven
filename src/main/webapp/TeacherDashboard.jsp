...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mycss/Maps/jquery-jvectormap-2.0.3.css" >
...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                ...
                <a href="TeacherStudentUsers.jsp" class="studentspage list-group-item list-group-item-action bg-dark text-white">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="TeacherProfileSettings.jsp" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Profile Settings</span>
                </a>
                <a href="TeacherChangePassword.jsp" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <!-- /END Separator -->
            <a href="TeacherCalendar.jsp" class="bg-white text-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <%
      ...
      int count = teacherDao.countStudents(teacher);//here count is the number of students
...
<script src="javascript/Dashboard/TeacherDashboardStudentCount.js"></script>

<script src="javascript/Dashboard/TeacherDashboardPie.js"></script>
