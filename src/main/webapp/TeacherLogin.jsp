...
<%
    ...
    {
        response.sendRedirect("StudentLogoutWarning.jsp");
    }
...
<head>
    ...
    <title>Teacher Login | StudentDiaries</title>
</head>
...
<div class="container heading">
    ...
    <%
        ...
        {
    %>
    <p id="error"><%= session.getAttribute("TeacherLoginIncorrectCredentials").toString() %></p>
    <%
            ...
            <div class="col-md-6">
                <form class=" innerform" action="/LoginVerificationServlet" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder="Email" aria-describedby="emailhelpinline" required>
                    ...
                    <div class="form-group">
                        <div class="forget ">
                            <a href="TeacherPasswordReset.jsp">Forget Password?</a>
                        </div>
                    </div>

                    <div class="lastdiv">
                        <p>Not a Teacher Member yet? <a href="TeacherSignup.jsp">Sign up</a></p>
                    </div>
