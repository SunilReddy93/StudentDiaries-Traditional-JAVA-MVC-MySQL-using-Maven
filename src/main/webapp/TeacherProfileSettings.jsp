...
<header id="header">
    <div class="container container1" id="container-header" >
        <div class="row">
            <div class="col-md-6">
                <div class="fafaicons">
                    <a href="TeacherDashboard.jsp" title="Dashboard"><i class="material-icons md-dark">arrow_back</i></a>
                </div>
            </div>


            <div class="fafaicons d-flex justify-content-end float-right ml-auto">
                <a  href="TeacherEditProfile.jsp" title="Edit Profile"><span><i class="material-icons">
create</i></span></a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/TeacherAccountDeletion"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end float-right">
                <a  id="profilename" href="#" title="Teacher Name">
                    <h3><%= WordUtils.capitalizeFully(teacher.getTeacherfirstname()) %></h3>
                </a>
            </div>
        </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-8 px-3">
                    <div class="card-block px-3">
                        <h5 class="card-title"><%= WordUtils.capitalizeFully(teacher.getTeacherfirstname()) %> <%= WordUtils.capitalizeFully(teacher.getTeacherlastname()) %></h5>
