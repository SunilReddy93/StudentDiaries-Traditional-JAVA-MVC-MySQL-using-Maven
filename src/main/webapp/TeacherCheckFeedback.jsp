...
<%
    ...
    if (session.getAttribute("teacheruser") != null && session.getAttribute("teacherpassword") != null)
    {
        ...
        try
        {
            ...
            boolean check = feedbackDao.getFeedbackDetails(student, feedback);
...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a href="TeacherStudentUsers.jsp" class="btn btn-primary">Go Back</a>
            </div>
        </div>
...
<%
            ...
            {
                response.sendRedirect("TeacherStudentNoFeedbackFound.jsp");
            }
        }
        catch(Exception e)
        {
