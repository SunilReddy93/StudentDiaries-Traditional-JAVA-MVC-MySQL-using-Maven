...
<head>
    ...
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" type="text/css" href="mycss/users/AdminProfileSettings.css"/>
...
<header id="header">
    <div class="container container1" id="container-header" >
        <div class="row">
            <div class="col-md-6">
                <div class="fafaicons">
                    <a href="StudentDashboard.jsp" title="Dashboard"><i class="material-icons md-dark">arrow_back</i></a>
                </div>
            </div>


            <div class="fafaicons d-flex justify-content-end float-right ml-auto">
                <a  href="StudentProfileUpdate.jsp" title="Edit Profile"><span><i class="material-icons">create</i></span></a></div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/StudentAccountDeletion"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end float-right">
                <a  id="profilename" href="#" title="Student Name">
                    <h3><%= WordUtils.capitalizeFully(student.getStudentfirstname()) %></h3>
                </a>
            </div>
        </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-8 px-3">
                    <div class="card-block px-3">
                        <h5 class="card-title"><%= WordUtils.capitalizeFully(student.getStudentfirstname()) %> <%= WordUtils.capitalizeFully(student.getStudentlastname()) %></h5>
                        <p class="card-text">Student ID: <%= student.getStudentid() %>,</p>
                        <p class="card-text">Reference Teacher ID: <%= student.getStudentteacherid() %>,</p>
                        <p class="card-text"><%= WordUtils.capitalizeFully(student.getStudentcoursename()) %>,  <%= WordUtils.capitalizeFully(student.getSchoolname()) %></p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><p>Roll No:  <%= student.getStudentrollno() %></p></li>
                            <li class="list-group-item"><p>Father Name:  <%= WordUtils.capitalizeFully(student.getStudentfathername()) %></p></li>
                            <li class="list-group-item"><p>Mother Name:  <%= WordUtils.capitalizeFully(student.getStudentmothername()) %></p></li>
                            <li class="list-group-item"><p><span><i class="fa fa-envelope"></i>  </span>  Personal Email ID:  <%= student.getStudentemailid() %></p></li>

                            <li class="list-group-item"><p><span><i class="fa fa-phone"></i></span>  Personal Phone No.:  <%= student.getStudentphoneno() %></p> </li>

                            <li class="list-group-item"><p><span><i class="fa fa-envelope"></i></span>  Parent Email ID:  <%= student.getParentemailid() %></p></li>

                            <li class="list-group-item"><p><span><i class="fa fa-phone"></i></span>  Parent Phone No.:  <%= student.getParentphoneno() %></p> </li>
