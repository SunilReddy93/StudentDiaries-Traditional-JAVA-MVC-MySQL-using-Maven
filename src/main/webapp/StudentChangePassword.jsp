...
<div class="col-md-6 offset-md-3">
    ...
    <div class="card  border-info">
        ...
        <div class="card-header form-inline">
            ...
            <img src="images/Lock.png" class="float-right" style="width: 30px; height: 30px;">
        </div>
        <div class="card-body">
            <form class="form" role="form" autocomplete="off" action="/StudentChangePasswordSubmit" method="post">
                ...
                <div class="form-group">
                    <a class="btn btn-primary btn-lg" href="StudentDashboard.jsp">Go Back</a>
